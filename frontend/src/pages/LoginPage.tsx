...
export default function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(ae.response?.data?.message || ae.response?.data?.detail || 'Invalid email or password')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen grid-bg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-violet-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="card-glow">
          ...
          <p className="text-xs text-slate-500 mb-6">Access your financial dashboard</p>
